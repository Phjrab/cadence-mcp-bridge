...
last_commit: 1fa06222fb1fad05a6051dfd75c770020e3d252a
last_push: 2026-08-28T19:19:04.5609044+09:00
awaiting_user_merge: false
remote_runner_deployed: true
codex_mcp_registered: true
last_e2e_result: fail
user_action_required: The Virtuoso process PID 25425 is no longer running, but the source schematic still contains the stale OA lock files `sch.oa.cdslck` and `sch.oa.cdslck.RHEL30.cadence.25425` plus the recovery-like `sch.oa-` artifact. Resolve these artifacts through the Cadence-supported recovery/cleanup workflow and provide fresh confirmation. Do not manually delete or force-release them under the current approval. Then resume WP-11 so their absence can be verified before the approved V2 validation. No v1 tag or release is permitted before a clean sequence passes.
```
