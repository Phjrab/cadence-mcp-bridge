...
$verifyCommand = "bash -n '$remoteRoot/bin/cadence-runner' '$remoteRoot/lib/runner-common.sh' '$remoteRoot/lib/run-smoke-job.sh' '$remoteRoot/lib/run-profile-job.sh' '$remoteRoot/lib/run-design-write-validation.sh' '$remoteRoot/lib/run-design-write-v2-recovery.sh' '$remoteRoot/lib/run-design-write-v3-validation.sh' '$remoteRoot/lib/run-design-write-v3-forensic.sh'; /usr/bin/python -m py_compile '$remoteRoot/py26/result_json.py' '$remoteRoot/py26/discovery_json.py' '$remoteRoot/py26/profile_json.py' '$remoteRoot/py26/write_validation_json.py' '$remoteRoot/py26/v2_recovery_json.py' '$remoteRoot/py26/v3_validation_json.py' '$remoteRoot/py26/v3_forensic_json.py'; rm -f '$remoteRoot/py26/result_json.pyc' '$remoteRoot/py26/discovery_json.pyc' '$remoteRoot/py26/profile_json.pyc' '$remoteRoot/py26/write_validation_json.pyc' '$remoteRoot/py26/v2_recovery_json.pyc' '$remoteRoot/py26/v3_validation_json.pyc' '$remoteRoot/py26/v3_forensic_json.pyc'; '$remoteRoot/bin/cadence-runner' version"
