...
$setupCommand = "umask 077; mkdir -p '$remoteRoot/bin' '$remoteRoot/lib' '$remoteRoot/py26' '$remoteRoot/config' '$remoteRoot/discovery' '$remoteRoot/discovery-runtime' '$remoteRoot/ade-profile-introspection' '$remoteRoot/wp14-role-discovery' '$remoteRoot/write' '$remoteRoot/write-validation' '$remoteRoot/write-rollback-v3' '$remoteRoot/write-validation-v4' '$remoteRoot/profiles/spectre-smoke' '$remoteRoot/profiles/fixture-rc-transient' '$remoteRoot/profiles/actual-differential-amplifier-tb2-transient' '$remoteRoot/jobs'; chmod 700 '$remoteRoot' '$remoteRoot/bin' '$remoteRoot/lib' '$remoteRoot/py26' '$remoteRoot/config' '$remoteRoot/discovery' '$remoteRoot/discovery-runtime' '$remoteRoot/ade-profile-introspection' '$remoteRoot/wp14-role-discovery' '$remoteRoot/write' '$remoteRoot/write-validation' '$remoteRoot/write-rollback-v3' '$remoteRoot/write-validation-v4' '$remoteRoot/profiles' '$remoteRoot/profiles/spectre-smoke' '$remoteRoot/profiles/fixture-rc-transient' '$remoteRoot/profiles/actual-differential-amplifier-tb2-transient' '$remoteRoot/jobs'"
...
$verifyCommand = "bash -n '$remoteRoot/bin/cadence-runner' '$remoteRoot/lib/runner-common.sh' '$remoteRoot/lib/run-smoke-job.sh' '$remoteRoot/lib/run-profile-job.sh' '$remoteRoot/lib/run-design-write-validation.sh' '$remoteRoot/lib/run-design-write-v2-recovery.sh' '$remoteRoot/lib/run-design-write-v3-validation.sh' '$remoteRoot/lib/run-design-write-v3-forensic.sh' '$remoteRoot/lib/run-design-write-v3-deep-forensic.sh' '$remoteRoot/lib/run-design-write-v3-exact-rollback.sh' '$remoteRoot/lib/run-design-write-v4-validation.sh'; /usr/bin/python -m py_compile '$remoteRoot/py26/result_json.py' '$remoteRoot/py26/discovery_json.py' '$remoteRoot/py26/profile_json.py' '$remoteRoot/py26/actual_profile_audit.py' '$remoteRoot/py26/write_validation_json.py' '$remoteRoot/py26/v2_recovery_json.py' '$remoteRoot/py26/v3_validation_json.py' '$remoteRoot/py26/v3_forensic_json.py' '$remoteRoot/py26/v3_deep_forensic_json.py' '$remoteRoot/py26/v3_exact_rollback_json.py' '$remoteRoot/py26/v4_validation_json.py'; rm -f '$remoteRoot/py26/result_json.pyc' '$remoteRoot/py26/discovery_json.pyc' '$remoteRoot/py26/profile_json.pyc' '$remoteRoot/py26/actual_profile_audit.pyc' '$remoteRoot/py26/write_validation_json.pyc' '$remoteRoot/py26/v2_recovery_json.pyc' '$remoteRoot/py26/v3_validation_json.pyc' '$remoteRoot/py26/v3_forensic_json.pyc' '$remoteRoot/py26/v3_deep_forensic_json.pyc' '$remoteRoot/py26/v3_exact_rollback_json.pyc' '$remoteRoot/py26/v4_validation_json.pyc'; '$remoteRoot/bin/cadence-runner' version"
$verifyCommand = $verifyCommand.Replace(
    "'$remoteRoot/lib/run-profile-job.sh'",
    "'$remoteRoot/lib/run-profile-job.sh' '$remoteRoot/lib/run-ade-profile-introspection.sh'"
)
$verifyCommand = $verifyCommand.Replace(
    "'$remoteRoot/py26/actual_profile_audit.py'",
    "'$remoteRoot/py26/actual_profile_audit.py' '$remoteRoot/py26/ade_profile_introspection.py'"
)
$verifyCommand = $verifyCommand.Replace(
    "'$remoteRoot/py26/actual_profile_audit.pyc'",
    "'$remoteRoot/py26/actual_profile_audit.pyc' '$remoteRoot/py26/ade_profile_introspection.pyc'"
)
